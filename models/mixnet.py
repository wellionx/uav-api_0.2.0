...
class MixNet(nn.Module):
    ...
    def __init__(self, net_type='mixnet_s',input_size=320, num_classes=1000, stem_channels=16, feature_size=1536,
...
if __name__ == '__main__':
    net = MixNet(net_type='mixnet_l').cuda()

    x_image = torch.randn(1, 3, 320, 320).cuda()
    y = net(x_image)
    print(y.size())
